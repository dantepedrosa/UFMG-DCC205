 ...
 * 
 * @details Descricao: imprime as opcoes de uso.
 * 
 * @return void
 */
void uso()
 ...
 * 
 * @details Descricao: lê as opções da linha de comando e inicializa variaveis.
 * 
 ...
 * 
 * @details Descricao: programa principal para execucao de operacoes de matrizes.
 * 
